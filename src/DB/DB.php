...
namespace SapphireSiteManager\DB;

/**
 * Custom DataBase functionality for the plugin.
 */
class DB {
	...
	public function __construct() {
		...
		$this->table_name = $wpdb->prefix . 'ssm_messages';
	}
	...
	public function run() {
		...
		$query        = "INSERT INTO $this->table_name (`species`, `birthyear`, `petweight`, `favfood`, `favhobby`, `favcolor`, `petname`) VALUES ";
		$numberofpets = 1;
